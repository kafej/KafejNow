...
(function($) {	
	$(document).ready(function () {
		...
		var refreshtimer;
		var searchterm = "< ?php echo $_GET['searchterm2']; ?>";
		
		var headerHTML = '';
		var loadingHTML = '';
		headerHTML += '<a href="https://twitter.com/" ><img src="img/bird_gray_16.png" width="16" style="float:left;padding:3px 12px 0px 6px" alt="twitter bird" /></a>';
		...
		function gettwitterjson() { 
			$.getJSON('config.php?keyword='+searchterm,
				function(feeds) {   
						...
						if(typeof feeds[i].retweeted_status != 'undefined'){
						 ...
						 if (((showretweets == true) || ((isaretweet == false) && (showretweets == false)))) { 
							if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {             
								...
								feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" ><img src="'+profileimage+'"img/twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
