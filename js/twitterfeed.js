...
$(document).ready(function (twitterprofile) {
    var displaylimit = 3;
    var twitterprofile = "kafej666";
	var screenname = "Kafej";
	...
	var headerHTML = '';
	var loadingHTML = '';
	headerHTML += '<a href="https://twitter.com/" target="_blank"><img src="img/bird_gray_16.png" style="float:left;padding:22px 4px 0px 0px" alt="twitter bird" /></a>';
	headerHTML += '<h1>'+screenname+' <span style="float:left;font-size:13px;margin-top: 4px;"><a href="https://twitter.com/'+twitterprofile+'" target="_blank">@'+twitterprofile+'</a></span></h1>';
